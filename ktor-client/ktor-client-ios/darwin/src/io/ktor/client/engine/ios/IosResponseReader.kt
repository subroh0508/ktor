...
class IosResponseReader(private val callContext: CoroutineContext) : NSObject(), NSURLSessionDataDelegateProtocol {
    private val chunks = Channel<ByteArray>(Channel.UNLIMITED)
    private val response = CompletableDeferred<NSURLSessionTask>()
